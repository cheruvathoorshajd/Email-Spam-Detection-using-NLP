...
Open Email_Spam_Detection.ipynb.
​

Ensure the dataset CSVs are available in the expected data/ paths used in the notebook (e.g., data/CEAS08.csv, data/Enron.csv, etc.).
​

Run all cells to reproduce EDA, training, evaluation, and generate bestspamdetector.pkl.
​
